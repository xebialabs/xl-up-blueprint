...
def runXlUpOnEks(String awsAccessKeyId, String awsSecretKeyId, String eksEndpoint, String efsFileId) {
    sh "sed -ie 's@https://aws-eks.com:6443@${eksEndpoint}@g' sample-answers/eks-xld-xlr-mon.yaml"
    sh "sed -ie 's@SOMEKEY@${awsAccessKeyId}@g' sample-answers/eks-xld-xlr-mon.yaml"
    sh "sed -ie 's@SOMEMOREKEY@${awsSecretKeyId}@g' sample-answers/eks-xld-xlr-mon.yaml"
    sh "sed -ie 's@test1234561@${efsFileId}@g' sample-answers/eks-xld-xlr-mon.yaml"
    sh "sed -ie 's@test-eks-master@xl-up-master@g' sample-answers/eks-xld-xlr-mon.yaml"
    sh "sed -ie 's@XldLic: ../xl-up/__test__/files/test-file@XldLic: ./deployit-license.lic@g' sample-answers/eks-xld-xlr-mon.yaml"
    sh "sed -ie 's@XlrLic: ../xl-up/__test__/files/test-file@XlrLic: ./xl-release.lic@g' sample-answers/eks-xld-xlr-mon.yaml"
    sh "sed -ie 's@XlKeyStore: ../xl-up/__test__/files/test-file@XlKeyStore: ./xl-up/__test__/files/keystore.jceks@g' sample-answers/eks-xld-xlr-mon.yaml"
    sh "sed -ie 's@8.6.1@9.0.2@g' sample-answers/eks-xld-xlr-mon.yaml"
    sh "./xld/xl-cli/build/linux-amd64/xl up -d -a sample-answers/eks-xld-xlr-mon.yaml -b xl-infra -l ."
}
...
def runXlUpOnPrem(String nsfSharePath) {
    ...
    sh "sed -ie 's@https://k8s.com:6443@${ON_PREM_K8S_API_URL}@g' sample-answers/on-prem-xld-xlr-mon.yaml"
    sh "sed -ie 's@K8sClientCertFile: ../xl-up/__test__/files/test-file@K8sClientCertFile: ./k8sClientCert-onprem.crt@g' sample-answers/on-prem-xld-xlr-mon.yaml"
    sh "sed -ie 's@K8sClientKeyFile: ../xl-up/__test__/files/test-file@K8sClientKeyFile: ./k8sClientCert-onprem.key@g' sample-answers/on-prem-xld-xlr-mon.yaml"
    sh "sed -ie 's@nfs-test.com@${NSF_SERVER_HOST}@g' sample-answers/on-prem-xld-xlr-mon.yaml"
    sh "sed -ie 's@/xebialabs@/${nfsSharePath}@g' sample-answers/on-prem-xld-xlr-mon.yaml"
    sh "sed -ie 's@XldLic: ../xl-up/__test__/files/test-file@XldLic: ./deployit-license.lic@g' sample-answers/on-prem-xld-xlr-mon.yaml"
    sh "sed -ie 's@XlrLic: ../xl-up/__test__/files/test-file@XlrLic: ./xl-release.lic@g' sample-answers/on-prem-xld-xlr-mon.yaml"
    sh "sed -ie 's@XlKeyStore: ../xl-up/__test__/files/test-file@XlKeyStore: ./xl-up/__test__/files/keystore.jceks@g' sample-answers/on-prem-xld-xlr-mon.yaml"
    sh "./xld/xl-cli/build/linux-amd64/xl up -v -d -a sample-answers/on-prem-xld-xlr-mon.yaml -b xl-infra -l ."
}