            ...
            steps {
                script {
                    try {
                        ...
                        sh "sed 's@https://aws-eks.com:6443@https://508989380AE5D31892EBB1750D19CFA3.yl4.eu-west-1.eks.amazonaws.com@g' xl-up/__test__/test-cases/external-db/eks-xld-xlr-mon.yaml"
                        sh "sed -e 's@SOMEKEY@\\$awsAccessKey@g' xl-up/__test__/test-cases/external-db/eks-xld-xlr-mon.yaml"
